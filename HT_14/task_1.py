"""
Додайте до банкомату меню отримання 
поточного курсу валют за допомогою requests 
    ...
    def menu(self, username):
        ...
        while no_exit:
            ...
            if action == '1':
                ...
                cash = input('1 Cash \nNon-cash \n:')
                if cash == '1':
                    currency = input("usd/eur\n:")
                    print(self.exchange_rate(currency))
                elif cash == '2':
                    currency = input("usd/eur\n:")
                    print(self.exchange_rate_noncash(currency))
            elif action == '5':
